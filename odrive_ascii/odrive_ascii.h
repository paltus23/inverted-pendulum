...
int odrv_q_pos(odrv_ascii_t *cli, int motor, double position, double vel_lim, double torque_lim);       // q m pos [vellim] [torquelim]
int odrv_p_pos_ff(odrv_ascii_t *cli, int motor, double position, double vel_ff, double torque_ff);      // p m pos [vff] [tff]
int odrv_v(odrv_ascii_t *cli, int motor, double velocity, double torque_ff);                            // v m vel [tff]
int odrv_c_torque(odrv_ascii_t *cli, int motor, double torque);                                         // c m tq
...
int odrv_ss_save(odrv_ascii_t *cli);
int odrv_se_erase(odrv_ascii_t *cli);
int odrv_sr_reboot(odrv_ascii_t *cli);
int odrv_sc_clear_errors(odrv_ascii_t *cli);
